          ...
          <div className="space-y-3 md:space-y-4 text-center sm:text-left">
            ...
            <div className="flex justify-center sm:justify-start gap-3">
              <a
                ...
                className="w-10 h-10 rounded-lg bg-card border border-border hover:bg-accent/10 flex items-center justify-center text-muted-foreground hover:text-foreground transition-all hover:scale-110"
              >
        ...
        <div className="pt-8 border-t border-border text-center">
          <p className="text-muted-foreground text-sm flex items-center justify-center gap-2">
            ...
            <span className="flex items-center gap-1">
              Hecho con{" "}
              <Heart className="w-3 h-3 text-destructive fill-destructive" /> y
              Next.js
            </span>
          </p>
        </div>
