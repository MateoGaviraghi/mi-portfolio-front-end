    ...
    <div className="w-full max-w-md">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-slate-400">
          Únete y empieza a explorar el portfolio
        </p>
      </div>
      ...
      <form onSubmit={handleSubmit(registerUser)} className="space-y-5">
        ...
        <div className="grid grid-cols-2 gap-3">
          <button
            type="button"
            className="flex items-center justify-center gap-2 px-4 py-2.5 bg-slate-900/50 border border-slate-800 rounded-lg text-slate-300 hover:bg-slate-900 hover:border-slate-700 transition-all"
          >
